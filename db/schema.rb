...
ActiveRecord::Schema.define(version: 20150618101355) do
  ...
  create_table "casino_proxy_tickets", force: :cascade do |t|
    ...
    t.boolean  "consumed",                 limit: 1,     default: false, null: false
  ...
  create_table "casino_service_rules", force: :cascade do |t|
    ...
    t.boolean  "regex",      limit: 1,   default: false, null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "casino_service_tickets", force: :cascade do |t|
    ...
    t.boolean  "consumed",                  limit: 1,     default: false, null: false
    t.boolean  "issued_from_credentials",   limit: 1,     default: false, null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "casino_ticket_granting_tickets", force: :cascade do |t|
    ...
    t.boolean  "awaiting_two_factor_authentication", limit: 1,     default: false, null: false
    t.boolean  "long_term",                          limit: 1,     default: false, null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end
